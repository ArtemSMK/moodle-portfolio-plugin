...
$string['pluginname'] = 'PortfolioSystem';
// === Shown in block title and all headers.
$string['blocktitle'] = 'PortfolioSystem';
$string['exaport:use'] = 'Use allowed';
$string['exaport:addinstance'] = 'add PortfolioSystem to the course';
$string['exaport:myaddinstance'] = 'add PortfolioSystem on My home';
...
$string['myportfoliotitle'] = 'PortfolioSystem module: Add your links and files here.';
...
$string['exportcomment'] = 'This is an exported file from PortfolioSystem. Please do not remove the comments, they are needed for the import!';
...
// === Views.
$string['view'] = 'Event';
$string['views'] = 'My events';
$string['explainingviews'] = 'Manage your events.';
$string['noviews'] = 'Please create a new event';
$string['viewnotfound'] = 'Event not found';
$string['newview'] = 'Add Event';
$string['viewinformation'] = 'Event Information';
$string['viewdescription'] = 'Description';
$string['viewdesign'] = 'Event Design';
...
$string['competences_old_version'] = 'An outdated version of Exabis Competences that is no longer supported by PortfolioSystem is installed on this moodle.';
...
$string['settings_interaktion_exacomp_head'] = 'Interaction PortfolioSystem - Exabis Competence Grid';
...
$string['block_exaport_maxbytes'] = 'Maximum uploaded file size in PortfolioSystem';
$string['block_exaport_maxbytes_body'] = 'This specifies a maximum size that uploaded files can be throughout the PortfolioSystem.<br> Value for whole site is: {$a->sitemaxbytes}. See <a href="{$a->settingsurl}">settings</a>';
$string['block_exaport_userquota'] = 'User quota for PortfolioSystem';
$string['block_exaport_userquota_body'] = 'The maximum number of bytes that a user can store in their own PortfolioSystem.<br> Value for whole site is: {$a->bytes}. See <a href="{$a->settingsurl}">settings</a>';
